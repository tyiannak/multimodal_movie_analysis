...
big dataset (985 Static VS 781 Non Static):
python3 LSTM_pytorch.py -v .............
"""
...
if __name__ == "__main__":
    ...
    np.save("_VGG16_binary_LSTM_y_test.npy", vals)
    np.save("_VGG16_binary_LSTM_y_pred.npy", preds)
